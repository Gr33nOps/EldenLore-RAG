...
# ==============================================================
# MAIN - runs both scrapes sequentially
# ==============================================================
def scrape_comprehensive():
    """Run the full comprehensive scrape from SCRAPE_LIST."""
    ...
    print(f"=== SCRAPING COMPREHENSIVE LIST ===")
    ...
    print(f"\n--- Comprehensive scrape complete: {done}/{total_entries} saved ({skipped} skipped) ---")


def scrape_missing():
    """Run the missing entries scrape from MISSING_ENTRIES."""
    os.makedirs("data/lore", exist_ok=True)
    ...
    print(f"\n=== SCRAPING MISSING ENTRIES ({len(MISSING_ENTRIES)} entries) ===")
    ...
    print(f"\n--- Missing scrape complete: file saved to {filepath} ---")
    print("Add this line to FILE_TO_CATEGORY in ingest.py:")
...
def main():
    ...
    scrape_missing()
    print("\n=== All scraping done. Now run: python ingest.py ===")
